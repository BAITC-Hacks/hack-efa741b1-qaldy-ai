...
Текущие ограничения: изменения хранятся в in-memory overlay и сбрасываются после перезапуска API; HR-аналитика, импорт дополнительных файлов, RBAC, SQLite и LLM adapter остаются следующими этапами.
